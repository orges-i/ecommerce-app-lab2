  ...
  return (
    <div className='my-10'>
        ...
        <div className='text-center py-8 text-3xl'>
            ...
            <Title text1={'KOLEKSIONI'} text2={'I FUNDIT'}/> {/* Komponenti Title */}
            <p className='w-3/4 m-auto text-xs sm:text-sm md:text-base text-gray-600'>Zbuloni produktet më të reja dhe trendet që sapo kanë mbërritur.</p>
        </div>
